...
#ifndef mi_uchar
#define mi_uchar unsigned char
#endif

#ifndef mi_ushort
#define mi_ushort unsigned short
#endif
...
#define NULL    0
    ...
    {
        mi_uchar head;  //0xAF开头
        mi_ushort parameter_len;
        mi_uchar* parameter;
        mi_uchar end;   //0xFA结尾
        //
        mi_uchar*frame_head;
    ...
    /*
     ...
     返回指令的长度
     */
    int miniDataCreate(mi_ushort parm_len,
                       const mi_uchar* parm,
                       mi_uchar* dst_buf);
     ...
     */
    int miniDataGet(mi_uchar* cache,int cache_len,TzhMiniData* pcmd,mi_uchar* is_get_cmd_success);
