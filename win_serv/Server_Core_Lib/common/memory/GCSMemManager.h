...
* @{
*/
template <typename Type> class CGCSMemManager
{
public:
	CGCSMemManager(void);
	~CGCSMemManager(void);
...
template<typename Type> CGCSMemManager<Type>::CGCSMemManager(void)
{
...
*/
template<typename Type> BOOL CGCSMemManager<Type>::Init(size_t szSize, size_t szMaxBlockCnt, size_t szFreeBloackCnt, BOOL bZero)
{
	m_szSize = szSize;
...
template<typename Type> int CGCSMemManager<Type>::GetCount()
{
...
template<typename Type> VOID CGCSMemManager<Type>::Destroy()
{
...
template<typename Type> Type* CGCSMemManager<Type>::MyNew(BOOL bZero)
{
	Type* pType = NULL;
...
template<typename Type> BOOL CGCSMemManager<Type>::MyDel(Type* p)
{
	if(p == NULL)
	{
		return TRUE;
